		...
		<div class="page_wrapper">
	      <div class="row">
			...
			<?php if ( is_active_sidebar('footer_one') ) { ?>
				<div class="col-sm-6 col-xs-12 col-lg-4 col-md-3">
	...
	function metrostore_footer_credit() { ?>
		<div class="col-sm-6 col-xs-12 coppyright">
			...
			<?php if ( apply_filters( 'metrostore_credit_link', true ) ) { 
				printf( __( '%1$s By %2$s', 'metrostore' ), ' ', '<a href=" ' . esc_url('https://sparklewpthemes.com/') . ' " alt="Premium WordPress Themes & Plugins by Sparkle Themes" title="Premium WordPress Themes & Plugins by Sparkle Themes" rel="designer" target="_blank">Sparkle Wp Themes</a>' ); ?>
			<?php } ?> 
		</div>
		<?php
	}
